...
mv kms vlmcsd
echo "KMS服务安装成功！"
echo "更多教程请访问：https://SavileLee.github.io/Profiles/KmsServer/kms.html"
}
...
case "$1" in
	...
	*)
	...
	echo "更多教程请访问：https://SavileLee.github.io/Profiles/KmsServer"
	;;
esac

# 转载请保留版权：https://kms.dreamstart.site